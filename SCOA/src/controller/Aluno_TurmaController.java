...
public class Aluno_TurmaController {
	
public boolean cadastrarAluno_Turma(int idTurma,int idAluno,float freq, float media, String status, String data) throws Exception{		
...
public boolean alterarAluno_Turma(int idAT, int idTurma,int idAluno,float freq, float media, String status, String data) throws Exception{
	...
	public boolean excluirAluno_Turma(int cod) throws Exception {
		...
		new Aluno_Turma().excluir(cod);
			return true;
	}
	
	public ArrayList<String> listar() throws Exception{
		//return new AlunoTurmaDao().listarAtores();
		return null;
	}
