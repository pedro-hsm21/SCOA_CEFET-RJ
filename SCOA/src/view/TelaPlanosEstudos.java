...
public class TelaPlanosEstudos extends JFrame {
	...
	public TelaPlanosEstudos() {
		...
		table.setModel(new DefaultTableModel(new Object[][] { { null, null }, }, new String[] { "Matrícula", "Curso" }) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int clicou = table.getSelectedRow();
				if (clicou >= 0) {
					int rs = JOptionPane.showConfirmDialog(null, "Excluir " + planoestudoss.get(clicou), "Atenção",
