...
public class TelaCadastroTurma extends JFrame {
	...
	public TelaCadastroTurma() throws ParseException {
		...
		spPeriodo.setBounds(91, 137, 40, 20);
		...
		lblNumAlunosCadastroTurma.setBounds(153, 137, 103, 20);
		panelCadastroTurma.add(lblNumAlunosCadastroTurma);

		spNumAlunos = new JSpinner();
		spNumAlunos.setBounds(266, 139, 40, 20);
		...
		lblTurnoCadastroTurma.setBounds(12, 166, 54, 20);
		panelCadastroTurma.add(lblTurnoCadastroTurma);

		tfTurno = new JTextField();
		tfTurno.setBounds(76, 168, 916, 20);
		...
		lblHorarioInicioCadastroTurma.setBounds(14, 197, 214, 20);
		...
		lblHorárioFimCadastroTurma.setBounds(14, 228, 198, 20);
		panelCadastroTurma.add(lblHorárioFimCadastroTurma);

		ftfHoraInicio = new JFormattedTextField();
		ftfHoraInicio.setBounds(238, 199, 70, 20);
		...
		ftfHoraFim.setBounds(222, 230, 70, 20);
		...
		lblNumAulasCadastroTurma.setBounds(327, 137, 93, 20);
		panelCadastroTurma.add(lblNumAulasCadastroTurma);

		spNumAulas = new JSpinner();
		spNumAulas.setBounds(430, 137, 40, 20);
