...
public class TelaConteudos extends JFrame {
	...
	public TelaConteudos() {
		...
		JLabel lblConteudos = new JLabel("Conteúdos Programáticos");
		...
		JButton btnNewButton = new JButton("Nova Conteúdo");
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int clicou = table.getSelectedRow();
				if (clicou >= 0) {
					int rs = JOptionPane.showConfirmDialog(null, "Excluir Conteúdo da " + conteudos.get(clicou).getTurma().getNome(),
